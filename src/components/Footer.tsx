    ...
    <footer className="py-5 lg:px-10 px-3 text-20">
      <div className="bg-cream w-full flex justify-between rounded-[35px] py-20 px-28">
        ...
        <div className='w-1/3 space-y-3'>
          <p><b>Registered Office</b><br />1050 Northgate Dr, Suite #120 San Rafael,<br /> California 94903, USA</p>
        ...
        <div className='w-1/3'>
          ...
          {Footermenus.map((item) =>
            <Link key={item.path} to={item.menu}><h5 className='space-x-3'>{item.menu}</h5></Link>
          )}
        </div>
      </div>
    </footer>
