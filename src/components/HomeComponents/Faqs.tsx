...
export const Faqs = () => {
    ...
    return (
        <>
            <div className="flex flex-col lg:flex-row px-3 md:px-10 lg:px-28 py-10 lg:py-20 gap-10" >

                {/* information container */}
                <div className="w-full lg:w-1/2 flex flex-col justify-between lg:mb-8">
                    <div>
                        <h3 className="text-forest text-28 md:text-38 lg:text-48 leading-none mb-5 font-bold text-center lg:text-start">
